...
async def create_indexes():
    ...
    await db.handoff_tokens.create_index("token", unique=True)
    await db.handoff_tokens.create_index("expires_at", expireAfterSeconds=0)
    await db.handoff_tokens.create_index("email")
